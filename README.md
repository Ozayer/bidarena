...
the full feature list and progress tracking, [USER_GUIDE.md](USER_GUIDE.md)
for the step-by-step flow for each user group, and [DEPLOYMENT.md](DEPLOYMENT.md)
for how to deploy it to free hosting. First tournament running on it: Tampere
Football Mania (TFM) - Season 8.
